...
if __name__ == "__main__":
    h5_path= "/media/opervu-user/Data2/ws/data_langgeonet_e3d_action/e3d_train_stratified.h5"
    lmdb_path = "/media/opervu-user/Data2/ws/data_langgeonet_e3d_action/lmdbs/doors/"
